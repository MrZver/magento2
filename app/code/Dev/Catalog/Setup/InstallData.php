...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                'type' => 'varchar',
                'label' => 'My custom product attribute',
                'backend' => '',
                'input' => 'text',
                ...
                'attribute_set' => 'MyCustomProductAttribute',
            ]
        );
        ...
        $eavSetup->addAttribute(
            ...
            'my_custom_category_attribute',
            [
                'type'         => 'varchar',
                'label'        => 'My custom category attribute',
                'input'        => 'text',
                'sort_order'   => 100,
                'source'       => '',
